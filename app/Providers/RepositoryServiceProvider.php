...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CompanyOccupationRepositoryInterface::class, CompanyOccupationRepository::class);
